...
<div class="panel login-panel">
 <div class="row">
  <div class="col-md-8 ">
  <div class="login-div">
  <p ><h2 class="text-center ">欢迎注册<strong>IDEAL</strong>微博</h2></p><br><br>
   ...
   <div class="form-group">
      ...
      <div class="col-sm-9">
         <input type="text" class="form-control" id="birthday" name="birthday"
            placeholder="生日" readonly="readonly">
      </div>
   </div>
   <div class="form-group">
   ...
   <div class="form-group">
      <div class="col-sm-offset-3 col-sm-9">
         <button type="button" class="btn btn-warning " id="signup">&nbsp;&nbsp;&nbsp;注册&nbsp;&nbsp;&nbsp;</button>
...
<br><br>
  ...
  <h4>已经有<strong>IDEAL</strong>微博账号？</h4>
  <h4>现在就去登录吧</h4><br>
  <a href="login.jsp" class="btn btn-success btn-lg">现在登录</a>
  </div>
  </div>
